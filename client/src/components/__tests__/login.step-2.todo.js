...
test('calls onSubmit with the username and password when submitted', () => {
  ...
  const { container, getByLabelText, getByText } = render(<Login onSubmit={handleSubmit} />, { container: div })
...
/*
http://ws.kcd.im/?ws=Testing&e=login.step-2%20(react-testing-library)&em=kshitijk83@gmail.com
*/
