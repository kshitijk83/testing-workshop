...
test('getPost returns the specific post', async () => {
  ...
  const fakePost = await db.insertPost(generate.postData())
  const req = {params: {id: fakePost.id}}
  const res = {
    json: jest.fn(),
  }
...
/*
http://ws.kcd.im/?ws=Testing&e=postsController&em=kshitijk83@gmail.com
*/
